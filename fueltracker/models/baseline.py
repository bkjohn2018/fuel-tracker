...
class SeasonalNaive:
    ...
    def fit(self, y: pd.Series) -> 'SeasonalNaive':
        ...
        logger.info("Seasonal Naïve model fitted", extra={
    ...
    def predict(self, horizon: int) -> np.ndarray:
        ...
        logger.debug("Generated forecasts", extra={
            "horizon": horizon,
            "period": self.period
        })
...
def rolling_backtest(
    ...
    **model_kwargs
    ...
    logger.info("Starting rolling backtest", extra={
        "total_length": len(y),
    ...
    for i in range(horizon, len(y_backtest)):
        ...
        required_period = model_kwargs.get('period', 12)  # Default to 12 if not specified
    ...
    logger.info("Rolling backtest completed", extra={
